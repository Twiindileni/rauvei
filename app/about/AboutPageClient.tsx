...
const DEFAULT_ABOUT_HERO = "/about_hero_boutique_interior_1775823933228.png";

export default function AboutPageClient({ heroImageUrl }: { heroImageUrl: string }) {
  const src = heroImageUrl?.trim() || DEFAULT_ABOUT_HERO;

  return (
    <main style={{ paddingTop: "120px" }}>
      <section className="hero" style={{ height: "60vh" }}>
        <div className="hero-bg">
          <img src={src} alt="RauVei Heritage" style={{ filter: "brightness(0.5)" }} />
        </div>
